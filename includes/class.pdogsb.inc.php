...
class PdoGsb
{
     ...
     *
     * @return array: la liste de tous les visiteurs
     */
     ...
     */
    public function getAllMontantFrais()
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
     ...
     *
     * @param String $id : l'id du visiteur dans la base de donn�es
     * @return array: Un tableau contenant l'id, le nom et le pr�nom du visiteur
     */
     ...
     *
     * @param String $idFraisHorsForfait : l'id du frais dans la base de donn�es
     * @param String $libelleFrais : le libell�l� du frais
     * @param String $dateFrais : la date du frais
     * @param String $montantFrais : le montant du frais
     */
    
    public function majFraisHf($idFraisHorsForfait, $libelleFrais, $dateFrais, $montantFrais)
    {
        
        $requetePrepare = PdoGSB::$monPdo->prepare(
            'UPDATE lignefraishorsforfait '
            . 'SET lignefraishorsforfait.libelle = :libelle '
            . ",lignefraishorsforfait.date = STR_TO_DATE(:date,'%d/%m/%Y')"
            . ',lignefraishorsforfait.montant = :montant '
            . 'WHERE lignefraishorsforfait.id = :idFrais'
            );
        $requetePrepare->bindParam(':libelle', $libelleFrais, PDO::PARAM_STR);
        $requetePrepare->bindParam(':date', $dateFrais, PDO::PARAM_STR);
        $requetePrepare->bindParam(':montant', $montantFrais, PDO::PARAM_INT);
        $requetePrepare->bindParam(':idFrais', $idFraisHorsForfait, PDO::PARAM_INT);
